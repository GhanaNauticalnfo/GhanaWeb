var keycloakInitialize = function (options) {

    var module = options.module;
    var moduleName = options.moduleName;
    var loginRequired = options.loginRequired;
    var loggedInPage = options.loggedInPage;
    ...
    angular.element(document).ready(function () {
        ...
        initOptions = initOptions || {onLoad: loginRequired ? 'login-required' : 'check-sso', checkLoginIframe: false};
